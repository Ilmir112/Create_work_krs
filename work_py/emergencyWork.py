...
def emergencyECN(self):
    emergency_list = [
        [None, None,
           f'При отрицательных результатах по срыву, по согласованию с УСРСиСТ увеличить нагрузку до 33т. '
    ...
    emergency_list = [
        [f'Завоз на скважину СБТл', None,
              ...
              [f'СПО лов.инстр', None,
               ...
               f'удлинитель (L=2м) + БП {sbt_select(self, "СБТ")} '
