...
def pop_down(self, region, curator_sel):
    ...
    if 'Ойл' in data_list.contractor:
        ...
        if region == 'ЧГМ' or region == 'ТГМ' or 'gnkt' in self.data_well.work_plan:
            nach_tkrs = podpis_dict[data_list.contractor]['Экспедиция']["ЦТКРС №1"]["chief_engineer"]["surname"]
            nach_tkrs_post = podpis_dict[data_list.contractor]['Экспедиция']["ЦТКРС №1"]["chief_engineer"]["post"]
        elif region == 'КГМ' or region == 'АГМ':
            nach_tkrs = podpis_dict[data_list.contractor]['Экспедиция']["ЦТКРС №2"]["chief_engineer"]["surname"]
            nach_tkrs_post = podpis_dict[data_list.contractor]['Экспедиция']["ЦТКРС №2"]["chief_engineer"]["post"]
        elif region == 'ИГМ':
            nach_tkrs = podpis_dict[data_list.contractor]['Экспедиция']["ЦТКРС №4"]["chief_engineer"]["surname"]
            nach_tkrs_post = podpis_dict[data_list.contractor]['Экспедиция']["ЦТКРС №4"]["chief_engineer"]["post"]
