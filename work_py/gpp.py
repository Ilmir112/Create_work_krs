    ...
    def grp_gpp_work(self, gpp_depth, current_depth, diameter_paker, gis_otz_after_true_quest):
        ...
        if gpp_300 is False:
            QMessageBox.warning(self, 'Ошибка',
                                'При проведении Работ с ГПП, согласно НГВП в компоновку ГРП добавляется пакер и '
                                'сажается на глубину 300м, для корректной работы необходимо добавить интервал '
                                'скреперования 280-320м при СПО ПСШ')
            return
