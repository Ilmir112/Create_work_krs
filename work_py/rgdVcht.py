...
def rgd_without_paker(self):
    rgd_list = [
        ...
        [None, None,
         f'Вызвать геофизическую партию. Заявку оформить за 16 часов через РИТС {data_list.contractor}". Составить'
         ...
         'мастер КРС', None],
        [None, None,
         f'Произвести  монтаж ГИС согласно схемы №11 при работе ГИС с утвержденной главным инженером  '
