...
type_kr_list = [
    ...
    'КР3-4  Очистка ствола и забоя  скважины от парафино-гидратных отложений, солей, гипса, песчаных и гидратных пробок',
    ...
    'КР3-7.1  Извлечение оборудования УЭЦН из скважины после аварии или инцидента, допущенного в процессе ремонта скважины',
    'КР3-7.2  Извлечение оборудования УЭДН из скважины после аварии или инцидента, допущенного в процессе ремонта скважины',
    'КР3-7.3  Извлечение оборудования УЭВН из скважины после аварии или инцидента, допущенного в процессе ремонта скважины',
    'КР3-7.4  Извлечение оборудования ШГН из скважины после аварии или инцидента, допущенного в процессе ремонта скважины',
    'КР3-7.5  Извлечение оборудования УШВН из скважины после аварии или инцидента, допущенного в процессе ремонта скважины',
    ...
    'КР6-8  Зарезка и бурение бокового ствола в скважине с многоствольным заканчива-нием и с проводкой горизонтального участка в продуктивном пласте',
    ...
    'КР8-1  Иследование характера насыщенности и выработки продуктивных пластов, уточнение геологического разреза в скважине',
