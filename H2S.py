...
class CalculateH2s:
    ...
    def calc_h2s(self, ws3, plast):
        ...
        SNPKH = [
            ...
            [None, '1.3.2.',
             'Длина подвески ЭК (ступень 1 верхняя)', 'м', int(self.data_well.shoe_column.get_value), 'ввод'],
            [None, '1.3.3.',
            ...
            [None, 3.3, 'Объем жидкости под ГНО, в т.ч.:', 'м3',
             '=ROUND(if(if(E14=0,(3.14*(E9-E10*2)^2/4/1000*(E8-E19)/1000),if(E19<E15,(3.14*(E12-E13*2)^2/4/1000*(E8-E19)/1000),((3.14*(E12-E13*2)^2/4/1000*(E8-E15)/1000) +3.14*(E9-E10*2)^2/4/1000*(E15-E19)/1000 )))<0, 0, if(E14=0,(3.14*(E9-E10*2)^2/4/1000*(E8-E19)/1000),if(E19<E15,(3.14*(E12-E13*2)^2/4/1000*(E8-E19)/1000),((3.14*(E12-E13*2)^2/4/1000*(E8-E15)/1000) +3.14*(E9-E10*2)^2/4/1000*(E15-E19)/1000 )))),2)  ',
             'формула'],
