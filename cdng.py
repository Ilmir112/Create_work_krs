...
def itog_1():
    ...
    itog_1 = [
        [None, 'ИТОГО:', None, None, None, None, None, None, None, None, None, f'=ROUND(SUM(L{CreatePZ.itog_ind_min}:L{CreatePZ.itog_ind_max}),1)'],
                  ...
                  [None, 'Непредвиденные  работы  : ', None, None, None, None, None, None, None, None, None, f'=ROUND(SUM(L{CreatePZ.itog_ind_min}:L{CreatePZ.itog_ind_max+2})*{CreatePZ.bottomhole_artificial}/100*0.0004 ,1)'],
                  [None, 'ВСЕГО  :', None, None, None, None, None, None, None, None, None, \
                   f'=ROUND(l{CreatePZ.itog_ind_max+3} + l{CreatePZ.itog_ind_max+4} + l{CreatePZ.itog_ind_max+5} + l{CreatePZ.itog_ind_max+6} +l{CreatePZ.itog_ind_max+7}, 1)'],
                  [None,
