...
def work_krs(self):
    ...
    if ('ЭЦН' in CreatePZ.dict_pump['do'].upper() or 'ВНН' in CreatePZ.dict_pump['do'].upper()) and (
        ...
        well_jamming = krs.well_jamming(self, without_damping_True, "ОРД")
        ...
        'do']) == '0':
        well_jamming = krs.well_jamming(self, without_damping_True, "ЭЦН")
        lift_ecn = [
            [None, None,
             ...
             'Мастер КРС представитель Заказчика ', 0.7],
            [None, None,
             f'Сбить сбивной клапан. {well_jamming[0]}',
             None, None, None, None, None, None, None,
             'Мастер КРС, представ заказчика', 3.2],
            [None, None, well_jamming[1],
             None, None, None, None, None, None, None,
             ' Мастер КРС', None],
            [None, None,
             f'{lifting_unit(self)}', None, None, None, None, None, None, None,
        ...
        well_jamming = krs.well_jamming(self, without_damping_True, "ЭЦН c пакером")
        lift_ecn_with_paker = [
            [None, None,
             'Опрессовать ГНО на Р=50атм в течении 30мин в присутствии представителя ЦДНГ. Составить акт. (Вызов представителя осуществлять '
             'телефонограммой за 12 часов, с подтверждением за 2 часа до начала работ) ПРИ НЕГЕРМЕТИЧНОСТИ НКТ ПОДЪЕМ ВЕСТИ С КАЛИБРОВКОЙ',
            ...
            [None, None,
             ...
             f'{"".join([" " if krs.without_damping(self) == True else f"Произвести глушение в НКТ в объеме {volume_pod_NKT()}м3.  {fluid_work}"])}'
        ...
        well_jamming = krs.well_jamming(self, without_damping_True, "НВ")
        lift_pump_nv = [
            [None, None,
             'Опрессовать ГНО на Р=40атм в течении 30мин в присутствии представителя ЦДНГ. Составить акт. (Вызов представителя осуществлять '
             'телефонограммой за 12 часов, с подтверждением за 2 часа до начала работ) ПРИ НЕГЕРМЕТИЧНОСТИ НКТ ПОДЪЕМ ВЕСТИ С КАЛИБРОВКОЙ',
        ...
        well_jamming = krs.well_jamming(self, without_damping_True, "НВ с пакером")
        ...
        well_jamming = krs.well_jamming(self, without_damping_True, "НН")
        lift_pump_nn = [
            [None, None,
             'Опрессовать ГНО на Р=40атм в течении 30мин в присутствии представителя ЦДНГ. Составить акт. (Вызов представителя осуществлять '
             'телефонограммой за 12 часов, с подтверждением за 2 часа до начала работ) ПРИ НЕГЕРМЕТИЧНОСТИ НКТ ПОДЪЕМ ВЕСТИ С КАЛИБРОВКОЙ',
        ...
        well_jamming = krs.well_jamming(self, without_damping_True, "НН с пакером")
        ...
        well_jamming = krs.well_jamming(self, without_damping_True, "воронка")
        ...
        well_jamming = krs.well_jamming(self, without_damping_True, "пакер")
        ...
        lift_orz = []
        try:
            well_jamming = krs.well_jamming(self, without_damping_True, "ОРЗ")
            lift_orz = [
                [None, None,
...
def well_jamming(self, without_damping, lift_select):
    ...
    elif without_damping  == False: # and lift_select in ['ОРД', 'воронка', 'НН с пакером', 'НВ с пакером','ЭЦН с пакером', 'ЭЦН', 'НВ', 'НН']:
