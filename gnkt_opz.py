...
def gnkt_work(self, H_F_paker_do, H2S, max_expected_pressure, max_admissible_pressure):
    print(H_F_paker_do, max_expected_pressure, max_admissible_pressure)
    ...
    # if H2S == True:
    #     fluid_work = f'{fluid_work}г/см3 с добавлением поглотителя сероводорода ХИМТЕХНО 101 Марка А из расчета ";=0.25+0.25:"кг/м3 '
    # else:
    ...
    [None, 14, f'Произвести  обработку ПЗП {V_rast}м3 растворителя в присутствии представителя Заказчика при открытом малом затрубном \
    ...
    [None, 23, f'Произвести гидросвабирование пласта в интервале 1311-1314м (закрыть затруб, произвести задавку в пласт \
