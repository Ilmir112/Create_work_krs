...
def lifting_unit(self):
    aprs_40 = 'Установить подъёмный агрегат на устье не менее 40т.\n' \
              'Пусковой комиссией составить акт готовности  подъемного агрегата и бригады для проведения ремонта ' \
              'скважины. \nПРИМЕЧАНИЕ:  ПРИ ИСПОЛЬЗОВАНИИ ПОДЪЕМНОГО АГРЕТАТА АПРС-40, А5-40, АПРС-50 ДОПУСКАЕТСЯ ' \
              'РАБОТА БЕЗ ПРИМЕНЕНИЯ ВЕТРОВЫХ ОТТЯЖЕК при скорости ветра не более 14 м/с и плотности грунта не менее ' \
              '5 кг см2.ПРИ ИСПОЛЬЗОВАНИИ подъемного АГРЕГАТА  УПА-60/80, А-50 РАБОТАТЬ ТОЛЬКО С ПРИМЕНЕНИЕМ 4 ' \
              'ОТТЯЖЕК. При использовании подъемного агрегата АПР 60/80, Барс-80 допускается работа без' \
              ' применения ветровых оттяжек до 50 тн. при скорости ветра менее 14 м/с и плотности грунта не ' \
              'менее 5 кг см2. При выполнении работ по ликвидации  аварии обязательно оснащение всех видов ' \
              'ПОДЪЕМНЫХ АГРЕГАТОВ 4 ОТТЯЖКАМИ. При превышении 75% от страгивающей нагрузки на все подъемные ' \
              'агрегаты оформляется наряд допуск на проведение работ повышенной опасности. МАКСИМАЛЬНУЮ НАГРУЗКА ' \
              'НЕ ДОЛЖНА ПРЕВЫШАТЬ 80% ОТ СТРАГИВАЮЩЕЙ НАГРУЗКИ НА НКТ. После монтажа подъёмника якоря ветровых ' \
              'оттяжек должны быть испытаны на нагрузки, установленные инструкцией по эксплуатации завода - ' \
              'изготовителя в присутствии супервайзера Заказчика. Составить акт готовности подъемного агрегата.' \
              ' Пусковой комиссией составить акт готовности  подъемного агрегата и бригады для проведения ремонта ' \
              'скважины. Дальнейшие работы продолжить после проведения пусковой ' \
              'комиссии заполнения пусковой документации.'

    upa_60 = 'Установить подъёмный агрегат на устье не менее 60т. \nПусковой комиссией составить ' \
             'акт готовности  подъемного агрегата и бригады для проведения ремонта скважины. \n' \
             'ПРИМЕЧАНИЕ:  ПРИ ИСПОЛЬЗОВАНИИ подъемного АГРЕГАТА  УПА-60/80, А-50 РАБОТАТЬ ТОЛЬКО С ПРИМЕНЕНИЕМ 4 ' \
              'ОТТЯЖЕК. При использовании подъемного агрегата АПР 60/80, Барс-80 допускается работа без' \
              ' применения ветровых оттяжек до 50 тн. при скорости ветра менее 14 м/с и плотности грунта не ' \
              'менее 5 кг см2. При выполнении работ по ликвидации  аварии обязательно оснащение всех видов ' \
              'ПОДЪЕМНЫХ АГРЕГАТОВ 4 ОТТЯЖКАМИ. При превышении 75% от страгивающей нагрузки на все подъемные ' \
