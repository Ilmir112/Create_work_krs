...
def rgdWithoutPaker(self):
    ...
    rgd_list = [
        [None, None, f'Спустить с замером воронку на НКТ  до  глубины 300м с замером, шаблонированием шаблоном 59,6мм. '
        ...
        [None, None, f'Произвести  монтаж ГИС согласно схемы  №8 при работе ГИС с утвержденной главным инженером от  14.10.2021г '
                     ...
                     f'устье {CreatePZ.max_admissible_pressure}атм, по невозможности на давление поглощения, но не менее 30атм '
