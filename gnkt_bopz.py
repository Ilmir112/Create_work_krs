...
class TabPageGnkt(TabPageUnion):
    ...
    def __init__(self, parent=None):
        ...
        self.fluid_project_edit.setText(self.data_well.fluid_edit)
    ...
    def gnkt_work(self, data_gnkt):
        ...
        gnkt_bopz = [
            ...
            [None, 3,
             ...
             None, None, None, None, None, None, None, None, 'Мастер ГНКТ'],
            [None, 4,
             f'Произвести завоз технологической жидкости в V не менее 10м3 плотностью '
             f'{self.data_well.fluid_work_edit}г/см3.',
            ...
            [None, 9,
             ...
             f'согласно «Схемы обвязки №16 устья противовыбросовым оборудованием при производстве работ по промывке '
            ...
            [None, 12,
             ...
             f'линии на {round(self.data_well.max_admissible_pressure.get_value*1.5, 1)}атм. Опрессовать ПВО, '
             ...
             f'атм с выдержкой 30мин в присутствии представителя ПФС. Опрессовку ПВО зафиксировать в вахтовом журнале. '
             f'Установить на малом и большом '
             ...
             f'проведение работ.',
             None, None, None, None, None, None, None, None, 'Мастер ГНКТ, ПФС'],
            ...
            [None, 26,
             ...
             f'жидкостью уд.весом {self.data_well.fluid_work_edit}г/см3 до '
            ...
            f' {self.data_well.current_bottom}м. Забой должен соответствовать – {self.data_well.current_bottom}м.'
             f' Составить АКТ на забой совместно с '
            ...
            [None, 33,
             ...
             f'жидкостью уд.весом {self.data_well.fluid_edit}. Произвести перерасчет забойного давления, '
