...
def work_krs(self):
    ...
    lift_paker = [[None, None,
            ...
            [None, None,
             ...
             f'объеме обеспечивающим заполнение трубного пространства и скважины в подпакерной зоне в объеме {volume_pod_NKT()} м3 жидкостью уд.веса {fluid_work} '
...
[None, None,
             f'Произвести смену объема прямой промывкой тех жидкостью уд.весом {fluid_work} на циркуляцию в объеме {round(volume_jamming_well()-volume_pod_NKT(),1)}м3, закрыть затрубную'
...
[None, None,
    ...
    lift_voronka = [[None, None,
             f'Произвести глушение скважины прямой промывкой тех жидкостью уд.весо {fluid_work} на циркуляцию в объеме '
             f'{volume_jamming_well()-volume_pod_NKT()}м3, закрыть затрубную задвижку. Произвести глушение в НКТ в объеме '
             f'{volume_pod_NKT()}м3 при давлении не более {CreatePZ.max_admissible_pressure}атм. Закрыть скважину на '
             f'стабилизацию не менее 2 часов. (согласовать глушение в коллектор, в случае отсутствия на желобную емкость', None, None, None, None, None, None, None,
...
[None, None,
             ...
             f'в объеме {round(sum(list(CreatePZ.dict_nkt.values())) * 1.12/1000, 1)}м3 с контролем АСПО на стенках НКТ.', None, None,
             None, None, None, None, None,
...
[None, None,
    ...
    lift_ecn = [
        ...
        [None, None,
             f'Сбить сбивной клапан. Произвести глушение скважины прямой промывкой тех жидкостью уд.весо {fluid_work} на циркуляцию в объеме '
             f'{volume_jamming_well()-volume_pod_NKT()}м3, закрыть затрубную задвижку. Произвести глушение в НКТ в объеме '
             f'{volume_pod_NKT()}м3 при давлении не более {CreatePZ.max_admissible_pressure}атм. Закрыть скважину на '
             f'стабилизацию не менее 2 часов. (согласовать глушение в коллектор, в случае отсутствия на желобную емкость', None, None, None, None, None, None, None,
             'Мастер КРС, представ заказчика', 3.2],
...
[None, None,
             ...
             None, None],
[None, None,
             f'Поднять  {CreatePZ.dict_pump["do"]}  на НКТ{nkt_diam_fond}мм с глубины {sum(list(CreatePZ.dict_nkt.values()))}м на поверхность с замером, накручиванием колпачков с доливом скважины тех.жидкостью уд. весом{fluid_work}  '
             f'в объеме {round(sum(list(CreatePZ.dict_nkt.values())) * 1.12/1000, 1)}м3 с контролем АСПО на стенках НКТ.', None, None,
             None, None, None, None, None,
    ...
    lift_pump_nn = [
        [None, None,
         ...
         'Мастер КРС представитель Заказчика ', 0.7],
        [None, None,
         f'Произвести глушение скважины обратной промывкой тех жидкостью уд.весом {fluid_work} на циркуляцию в объеме '
         f'{volume_jamming_well() - volume_pod_NKT()}м3, закрыть затрубную задвижку. Произвести глушение в затруб в объеме '
         f'{volume_pod_NKT()}м3 при давлении не более {CreatePZ.max_admissible_pressure}атм. Закрыть скважину на '
        ...
        [None, None,
         ...
         f'штанги. Поднять на штангах плунжер с гл. {CreatePZ.dict_pump_h["do"]}м с доливом тех жидкости уд.весом {fluid_work}г/см3 '
         f'Обеспечить не превышение расчетных нагрузок на штанговые колонны при срыве  насосов (не более 8 тн), без учета веса '
         f'штанг в  0,9т. При отрицательном результате согласов технологической службой ЦДНГ или ПТО региона  постепенное увеличение нагрузки до 15тн ( по 1т - 1 час),  либо искусственный  отворот НШ с последующим комбинированным подъемом ГНО НВ. В случае невозможности отворота колонны НШ с подтверждением супервайзера, распиловку НШ согласовать с ПТО по направлению сектора учета НКТ и НШ.', None, None, None, None, None, None, None,
         'Мастер КРС представитель Заказчика, пусков. Ком. ', round((0.17+0.015*CreatePZ.dict_pump_h["do"]/8.5+0.12+1.02),1)],
        ...
        [None, None,
         pvo_gno(), None, None,
         None, None, None, None, None,
         ''.join(['Мастер КРС, представ-ли ПАСФ и Заказчика, Пуск. ком' if CreatePZ.bvo == True else 'Мастер КРС, представ-ли  Заказчика']),
         2.67],
        [None, None,
         f'Опрессовку ПВО проводить после каждого монтажа. (ОПРЕССОВКУ ПВО ЗАФИКСИРОВАТЬ В ВАХТОВОМ ЖУРНАЛЕ).',
         None, None,
    ...
    lift_pump_nv = [
        ...
        [None, None,
         ...
         'Мастер КРС представитель Заказчика, пусков. Ком. ', 4.2],
        [None, None,
         f'Сорвать насос {CreatePZ.dict_pump["do"]} (зафиксировать вес при срыве). Обвязать устье скважины согласно схемы №3 утвержденной главным '
         f'инженером от 14.10.2021г при СПО штанг (ПМШ 62х21 либо аналог). Опрессовать ПВО на 40атм.  Поднять на штангах насос '
         f'с гл. {CreatePZ.dict_pump_h["do"]}м с доливом тех жидкости уд.весом {fluid_work}г/см3 '
         f'Обеспечить не превышение расчетных нагрузок на штанговые колонны при срыве  насосов (не более 8 тн), без учета веса '
         ...
         round((0.17 + 0.015 * CreatePZ.dict_pump_h["do"] / 8.5 + 0.12 + 1.02), 1)],
    ...
    lift_pump_nv_with_paker = [
        ...
        [None, None,
         f'Сорвать насос {CreatePZ.dict_pump["do"]} (зафиксировать вес при срыве). Обвязать устье скважины согласно схемы №3 утвержденной главным '
         f'инженером от 14.10.2021г при СПО штанг (ПМШ 62х21 либо аналог). Опрессовать ПВО на 40атм. Произвести глушение в НКТ в объеме{volume_pod_NKT()}м3. '
         f'Техостой 2ч. Поднять на штангах насос с гл. {CreatePZ.dict_pump_h["do"]}м с доливом тех жидкости уд.весом {fluid_work}г/см3 '
         f'Обеспечить не превышение расчетных нагрузок на штанговые колонны при срыве  насосов (не более 8 тн), без учета веса '
         f'штанг в  0,9т. При отрицательном результате согласов технологической службой ЦДНГ или ПТО региона  постепенное увеличение нагрузки до 15тн ( по 1т - 1 час),  либо искусственный  отворот НШ с последующим комбинированным подъемом ГНО НВ. В случае невозможности отворота колонны НШ с подтверждением супервайзера, распиловку НШ согласовать с ПТО по направлению сектора учета НКТ и НШ.',
         None, None, None, None, None, None, None,
         'Мастер КРС представитель Заказчика, пусков. Ком. ',
        ...
        [None, None,
         ...
         'Мастер КРС представитель Заказчика', 1.5],
        [None, None,
         f'Произвести глушение скважины прямой промывкой тех жидкостью уд.весом {fluid_work} на циркуляцию в объеме '
         f'{volume_jamming_well() - volume_pod_NKT()}м3. Закрыть скважину на '
         f'стабилизацию не менее 2 часов. (согласовать глушение в коллектор, в случае отсутствия на желобную емкость',
         None, None, None, None, None, None, None,
         'Мастер КРС, представ заказчика', 3.2],
        [None, None,
        ...
        [None, None,
         ...
         None, None],
        [None, None,
         f'Поднять  замковую опору с пакером {CreatePZ.paker_do["do"]} на НКТ{nkt_diam_fond}мм с глубины {sum(list(CreatePZ.dict_nkt.values()))}м на поверхность с замером, накручиванием колпачков с доливом скважины тех.жидкостью уд. весом{fluid_work}  '
         f'в объеме {round(sum(list(CreatePZ.dict_nkt.values())) * 1.12 / 1000, 1)}м3 с контролем АСПО на стенках НКТ.',
         None, None,
         None, None, None, None, None,
    ...
    lift_pump_nn_with_paker = [
        ...
        [None, None,
         ...
         f'инженером от 14.10.2021г при СПО штанг (ПМШ 62х21 либо аналог). Опрессовать ПВО на 40атм. Спуском одной штанги заловить конус. Произвести глушение в НКТ в объеме{volume_pod_NKT()}м3. '
         f'Техостой 2ч. Поднять на штангах насос {CreatePZ.dict_pump["do"]}с гл. {CreatePZ.dict_pump_h["do"]}м с доливом тех жидкости уд.весом {fluid_work}г/см3 '
         f'Обеспечить не превышение расчетных нагрузок на штанговые колонны при срыве  насосов (не более 8 тн), без учета веса '
         f'штанг в  0,9т. При отрицательном результате согласов технологической службой ЦДНГ или ПТО региона  постепенное увеличение нагрузки до 15тн ( по 1т - 1 час),  либо искусственный  отворот НШ с последующим комбинированным подъемом ГНО НВ. В случае невозможности отворота колонны НШ с подтверждением супервайзера, распиловку НШ согласовать с ПТО по направлению сектора учета НКТ и НШ.',
         None, None, None, None, None, None, None,
         'Мастер КРС представитель Заказчика, пусков. Ком. ',
        ...
        [None, None,
         ...
         None, None],
        [None, None,
         f'Поднять  насос {CreatePZ.dict_pump["do"]} с пакером {CreatePZ.paker_do["do"]} на НКТ{nkt_diam_fond}мм с глубины {sum(list(CreatePZ.dict_nkt.values()))}м на поверхность с замером, накручиванием колпачков с доливом скважины тех.жидкостью уд. весом{fluid_work}  '
         f'в объеме {round(sum(list(CreatePZ.dict_nkt.values())) * 1.12 / 1000, 1)}м3 с контролем АСПО на стенках НКТ.',
         None, None,
         None, None, None, None, None,
         'Мастер КРС', round(0.0044 * 1.2 * sum(list(CreatePZ.dict_nkt.values())), 2)],
    ...
    lift_ecn_with_paker = [
        ...
        [None, None,
         ...
         'Мастер КРС представитель Заказчика, пусков. Ком. ', 4.2],
        [None, None,
         f'Сбить сбивной клапан. Произвести глушение в НКТ в объеме {volume_pod_NKT()}м3.  {fluid_work}', None, None, None, None, None, None, None,
         'Мастер КРС представитель Заказчика, пусков. Ком. ', 4.2],
        ...
        [None, None,
         ...
         None, None],
        [None, None,
         f'Поднять  {CreatePZ.dict_pump["do"]} с пакером {CreatePZ.paker_do["do"]} на НКТ{nkt_diam_fond}мм с глубины {sum(list(CreatePZ.dict_nkt.values()))}м на поверхность с замером, накручиванием колпачков с доливом скважины тех.жидкостью уд. весом{fluid_work}  '
    ...
    lift_ord = [
        ...
        [None, None,
         ...
         None, None],
        [None, None,
         f'Поднять  ЭЦН с пакером {CreatePZ.paker_do["do"]} на НКТ{nkt_diam_fond}мм с глубины {sum(list(CreatePZ.dict_nkt.values()))}м на поверхность с замером, накручиванием колпачков с доливом скважины тех.жидкостью уд. весом{fluid_work}  '
         f'в объеме {round(sum(list(CreatePZ.dict_nkt.values())) * 1.12 / 1000, 1)}м3 с контролем АСПО на стенках НКТ.',
         None, None,
         None, None, None, None, None,
         'Мастер КРС', round(0.0044 * 1.2 * sum(list(CreatePZ.dict_nkt.values())), 2)],
    ...
    try:
        ...
        print('ОРЗ нет')
    return krs_begin + lift_pump_nv_with_paker+ posle_lift + template_work.template_ek()+ opressovka.paker_list()
