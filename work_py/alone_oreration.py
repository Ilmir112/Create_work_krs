...
def definition_Q_nek(self):
    ...
    definition_Q_list = [[f'Насыщение 5м3 Q-{plast} при {CreatePZ.max_admissible_pressure._value}', None,
                           f'Произвести насыщение скважины по затрубу до стабилизации давления закачки не '
                           f'менее 5м3. Опробовать  '
                           f' на приемистость {plast} при Р={CreatePZ.max_admissible_pressure._value}атм в присутствии '
