...
class TabPageSoChange(TabPageUnion):
    def __init__(self, parent=None):
        ...
        self.validator_float_five = QDoubleValidator(0, 50, 5)
        ...
        self.type_absorbent.addItems(['ХИМТЕХНО 101 Марка А', 'EVASORB марки 123', 'СНПХ-1200', 'ПСВ-3401 марка Б',
    ...
    def update_change_fluid(self, index):
        if index == 'Да':
            ...
            if not category_h2s_list_plan:
                ...
                self.h2s_pr_edit.setValidator(self.validator_float_five)
