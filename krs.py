...
def work_krs(self):
    ...
    lift_paker = [[None, None,
                  ...
                  [None, None,
                   f'Произвести смену объема прямой промывкой тех жидкостью уд.весом {fluid_work} на циркуляцию в объеме {round(round(volume_jamming_well(self) - volume_pod_NKT(), 1), 1)}м3, закрыть затрубную'
    ...
    lift_voronka = [[None, None,
                     ...
                     f'{round(volume_jamming_well(self) - volume_pod_NKT(), 1)}м3, закрыть затрубную задвижку. Произвести глушение в НКТ в объеме '
    ...
    lift_pump_nn = [
        ...
        [None, None,
         ...
         f'{round(volume_jamming_well(self) - volume_pod_NKT(), 1)}м3, закрыть затрубную задвижку. Произвести глушение в затруб в объеме '
         f'{volume_pod_NKT()}м3 при давлении не более {CreatePZ.max_admissible_pressure}атм. Закрыть скважину на '
         f'стабилизацию не менее 2 часов. (согласовать глушение в коллектор, в случае отсутствия на желобную емкость',
         None, None, None, None, None, None, None,
         'Мастер КРС, представ заказчика', 3.2],
