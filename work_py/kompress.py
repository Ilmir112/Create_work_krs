    ...
    def kompress(self, plast_combo, kompress_TypeCombo, khvost_edit, kompress_volume, count_muft,
        ...
        paker_list = [
            ...
            [None, None,
             ...
             'мастер КРС', None],
            [None, None,
             f'Произвести  монтаж ГИС согласно схемы  №8 при свабированиии утвержденной главным инженером от {well_data.dict_contractor[well_data.contractor]["Дата ПВО"]}г. '
