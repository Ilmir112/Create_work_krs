...
def gnkt_work(self, volume_gntk, fluid_work_insert):
    ...
    gnkt_opz = [
        ...
        [None, 10, f'Произвести монтаж 4-х секционного превентора БП 80-70.00.00.000 (700атм) и инжектора н'
                   ...
                   f'инженером  {well_data.dict_contractor[well_data.contractor]["Дата ПВО"]}г. Произвести обвязку установки ГНКТ, насосно-компрессорного '
        ...
        [None, 24, f'НОРМАЛИЗАЦИЯ ЗАБОЯ СКВАЖИНЫ',
         ...
         'Мастер ГНКТ,', None],
        [None, 25,
         f'После отбивки текущего забоя (головы проппанта) произвести подъем КНК -1 до '
         f'гл.{niz_nkt - 20}м.',
         None, None, None, None, None, None, None,
         'Мастер ГНКТ', 12.5],
        [None, 26,
        ...
        [None, 29, f'При достижении глубины {well_data.current_bottom}м произвести прокачку гелевой пачки в V=2-3м3, '
         ...
         None, None, None, None, None, None, None,
         'Мастер ГНКТ', 2.5],
        [None, f'ПОДТВЕРЖДЕНИЕ НОРМАЛИЗОВАННОГО ЗАБОЯ',
         None, None, None, None, None, None, None,
         None, None, None],
        [None, 29,
        ...
        [None, 29, f'Дальнейшие работы, согласовать с Заказчиком, по результам 1го цикла освоения: \n'
                   ...
                   f'- подтверждение / отмена проведения ГИС О.З.',
         None, None, None, None, None, None, None,
         'Мастер ГНКТ', None],
        ...
        [None, 29, f'Скорость спуска по интервалам:\n'
                   ...
                   f'в интервале {niz_nkt - 20}-{well_data.perforation_roof - 10}м не более 2м/мин;\n'
...
def calc_volume_jumping(self):
    ...
    if well_data.depth_fond_paker_do["do"] != '0':
        ...
        volume = work_py.alone_oreration.volume_jamming_well(well_data.current_bottom)
    return volume
