...
def rgdWithoutPaker(self):
    ...
    rgd_list = [
        [f'СП НКТ 300м', None, f'Спустить с замером воронку на НКТ до  глубины 300м с замером, шаблонированием шаблоном 59,6мм. '
    ...
    if ori == QMessageBox.StandardButton.Yes:
        ...
        rgd_list.append([None, None,
                         f'Поднять компоновку с доливом скважины в объеме 0.3м3 тех. жидкостью  уд.весом {CreatePZ.fluid_work}г/см3',
                         None, None, None, None, None, None, None,
                         'Мастер КРС', 1.3])
    else:
        rgd_list.append([None, None,
