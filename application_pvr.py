...
class PvrApplication(WindowUnion):
        ...
        for pvr in self.data_well.index_row_pvr_list:
            for row in range(pvr[0], pvr[1]):
                ...
                for col in range(2, 9):
                    row_list.append(
                        str(self.data_well.ws.cell(row=row + 1, column=col + 1).value)
                    )
    ...
    def add_row_table(self):
        ...
        edit_holes_metr = (
            self.tab_widget.currentWidget().lineedit_holes_metr.currentText()
        )
        edit_index_formation = (
            self.tab_widget.currentWidget().lineedit_index_formation.text()
        )
        ...
        if float(edit_type2.replace(",", ".")) >= float(self.data_well.current_bottom):
            QMessageBox.information(
                self, "Внимание", "Подошва интервала перфорации ниже текущего забоя"
            )
            return
        ...
        self.tableWidget.setItem(
            ...
            4,
            QTableWidgetItem(
                str(int((float(edit_type2) - float(edit_type)) * int(edit_holes_metr)))
            ),
        )
    ...
    def add_work(self):
        ...
        wb = openpyxl.load_workbook(
            f"{data_list.path_image}property_excel/template_pvr.xlsx"
        )
    ...
    def application_pvr_def(
        ...
        value_list = [
            ...
            [
                "на проведение прострелочно-взрывных работ",
                None,
                None,
                None,
                None,
            ...
            [
                None,
                "Внутр. диаметр насосно-компрессорных труб, мм",
                None,
                None,
                None,
                None,
            ...
            [
                None,
                "Гидростатическое давление в интервале работ, атм",
                None,
                None,
                None,
                None,
            ...
            [
                ...
                None,
                None,
                self.data_well.gaz_factor_percent[0],
                None,
                None,
                None,
                None,
            ...
            [
                ...
                None,
                None,
                f'{self.data_well.dict_pump_ecn["before"]}',
                None,
                None,
                None,
                None,
            ...
            [
                ...
                None,
                None,
                "№ заявки, присвоенный в ЦДС-Менеджер",
                None,
                None,
                None,
                None,
