...
def gnkt_work(self, volume_gntk, fluid_work_insert):
    ...
    gnkt_opz = [
        ...
        [None, 10, f'Произвести монтаж 4-х секционного превентора БП 80-70.00.00.000 (700атм) и инжектора н'
                   f'а устье скважины согласно «Схемы обвязки №16 устья противовыбросовым оборудованием при '
                   f'производстве работ по промывке скважины с установкой «ГНКТ» утвержденная главным '
                   f'инженером  {data_list.DICT_CONTRACTOR[data_list.contractor]["Дата ПВО"]}г. Произвести обвязку установки ГНКТ, насосно-компрессорного '
        ...
        [None, 29, f'По истечении 2х часов, произвести допуск КНК-1 на г/трубе в скважину '
                   ...
                   f'Составить АКТ на забой совместно с представителем Заказчика. '
