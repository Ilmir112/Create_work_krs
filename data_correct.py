        ...
        try:
            ...
            if data_list.connect_in_base:
                params = {
                    ...
                    "bottom_hole_drill": self.data_well.bottom_hole_drill.get_value,
                    "bottom_hole_artificial": self.data_well.bottom_hole_artificial.get_value,
                    "max_angle": self.data_well.max_angle.get_value,
                    "distance_from_rotor_table": self.data_well.distance_from_well_to_sampling_point,
                    "max_angle_depth": self.data_well.max_angle_depth.get_value,
                    "max_expected_pressure": self.data_well.max_expected_pressure.get_value,
                    "max_admissible_pressure": self.data_well.max_admissible_pressure.get_value,
                    "rotor_altitude": 0,
                    ...
                    "diameter_doloto_ek": self.data_well.diameter_doloto_ek.get_value,
