...
TYPE_TR_LIST = ['',
                'ТР1-8 Ввод прочих скважин',
                'ТР2-1 Фонтанный -газлифт',
                'ТР2-2 Фонтанный -ШГН',
                'ТР2-3 Фонтанный -УЭЦН',
                'ТР2-4 Фонтанный -УЭВН',
                'ТР2-5 Фонтанный -УШВН',
                'ТР2-6 Газлифт -ШГН',
                'ТР2-7 Газлифт -УЭЦН',
                'ТР2-8 Газлифт -УЭВН',
                'ТР2-9 Газлифт -УШВН',
                'ТР2-10 Перевод скважин на другой способ эксплуатации ШГН-УЭЦН',
                'ТР2-11 Перевод скважин на другой способ эксплуатации ШГН-УЭВН',
                'ТР2-12 Перевод скважин на другой способ эксплуатации ШГН-УШВН',
                'ТР2-13 Перевод скважин на другой способ эксплуатации УЭЦН-ШГН',
                'ТР2-14 Перевод скважин на другой способ эксплуатации УЭЦН-УШВН',
                'ТР2-15 Перевод скважин на другой способ эксплуатации УЭЦН-УЭВН',
                'ТР2-16 Перевод скважин на другой способ эксплуатации УШВН-УЭЦН',
                'ТР2-17 Перевод скважин на другой способ эксплуатации УШВН-ШГН',
                'ТР2-18 Прочие виды перевода',
                'ТР2-18-1 ШГН-ОРЭ',
                'ТР2-18-2 УЭЦН-ОРЭ и т.д.',
                'ТР2-18-3 Другие виды перевода',
                'ТР3-1 Изменение глубины подвески, смена типоразмера ШГН',
                'ТР3-2 Изменение глубины подвески, смена типоразмера УЭЦН',
                'ТР3-3 Изменение глубины подвески, смена типоразмера УЭВН',
                'ТР3-4 Изменение глубины подвески, смена типоразмера УШВН',
                'ТР3-5 Изменение глубины подвески, смена типоразмера других видов насосов',
                'ТР3-6 Изменение режима работы газлифтного подъёмника заменой скважинного оборудования',
                'ТР3-7 Спуск высокопроизводительного и высоконапорного скважинного оборудования с глубоким погружением',
                'ТР4-1 Ревизия и смена насоса',
                'ТР4-1-1 Ревизия или смена насоса скважинного невставного (НСН)',
                'ТР4-1-2 Ревизия или смена насоса скважинного вставного (НСВ)',
                'ТР4-2-1 Устранение обрыва штанг со сменой насоса НСН',
                'ТР4-2-2 Устранение обрыва штанг со сменой насоса НСВ',
                'ТР4-2-3 Устранение обрыва штанг без смены насоса НСН',
                'ТР4-2-4 Устранение обрыва штанг без смены насоса НСВ',
                'ТР4-3-1 Устранение отворота штанг со сменой насоса НСН',
                'ТР4-3-2 Устранение отворота штанг со сменой насоса НСВ',
                'ТР4-3-3 Устранение отворота штанг без смены насоса НСН',
                'ТР4-3-4 Устранение отворота штанг без смены насоса НСВ',
                'ТР4-4 Замена колонны штанг',
                'ТР4-5 Замена полированного штока',
                'ТР4-6 Замена, опрессовка и устранение негерметичности НКТ',
                'ТР4-7 Очистка и пропарка НКТ и штанг',
                'ТР4-8 Ревизия, смена устьевого оборудования',
                'ТР4-9 Прочие виды ремонта по ШГН',
                'ТР4-10 Смена замковой опоры',
                'ТР4-11 Ликвидация обрыва НКТ',
                'ТР4-12 Устранение заклинивания плунжера',
                'ТР4-13 Прочие ремонты оборудованные ШГН (УШВН)',
                ...
                'ТР5-7 Прочие виды ремонта по УЭЦН (наращивание кабеля на устье и др.)',
                'ТР6-1 Ревизия, смена, опрессовка и устранение негерметичности НКТ',
                'ТР6-2 Очистка и пропарка НКТ',
                'ТР6-3 Ревизия, смена устьевого оборудования',
                'ТР6-4 Прочие виды ремонта по фонтанным скважинам',
                ...
                'ТР7-5 Прочие виды ремонта по газлифтным скважинам',
                'ТР8-1 Ревизия, смена оборудования артезианских скважин',
                'ТР8-2 Ревизия, смена оборудования поглощающих скважин',
                'ТР9-1 Промывка ствола скважины горячей нефтью (водой) с добавлением ПАВ',
                'ТР9-2 Промывка ствола скважины углеводородными растворителями',
                'ТР9-3 Промывка забоя скважины горячей нефтью (водой) с добавлением ПАВ',
                'ТР9-4 Промывка забоя скважины углеводородными растворителями',
                'ТР9-5 Обработка ПЗП химическими реагентами (СКО, ГКО, БФА и т.д.)',
                'ТР9-6 Прочие виды очистки забоя и ствола скважины',
                'ТР10 Прочие виды работ',
                'ТР10-1 Исследование скважин',
                'ТР10-2 Прочие виды работ',
                'ТР11 Опытные работы по испытанию новых видов подземного оборудования'
                ]
TYPE_KR_LIST = [
    '',
