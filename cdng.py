    ...
    if 'Ойл' in contractor:
        ...
        events_gnvp = [
            ...
            [None, 5,
             ...
             'определенным ПЛА (отрезать кабель, закрепить к трубе ниже запорной компоновки, загерметизировать '
            ...
            #        f' {self.data_well.dict_perforation[self.data_well.plast_work[0]]["БСУ"]}м',
            #  None, None, None, None, None, None, None, None, None],
            [None, 1, 'Производить замер статического уровня (БСУ) в скважине согласно Инструкции "ОПРЕДЕЛЕНИЕ '
                      'СТАТИЧЕСКОГО УРОВНЯ ЖИДКОСТИ ПРИ ПРОВЕДЕНИИ ТЕКУЩЕГО, КАПИТАЛЬНОГО РЕМОНТА И ОСВОЕНИЯ '
                      'СКВАЖИН ПОСЛЕ  БУРЕНИЯ № П1-01.05. И-089042 ЮЛ-305.  \n'
                      'Определение БСУ в процессе ТКРС производится с отражением результатов в вахтовом журнале:',
             None, None, None, None, None, None, None, None, None],
            [None, 2, '- на скважинах с газовым фактором более 200 м3/т;\n'
                      '- на скважинах с отсутствием циркуляции и большим поглощением пласта;',
             None, None, None, None, None, None, None, None, None],
            [None, 3, '* по окончании глушения / промывки технологический отстой не производится, '
                      'замер уровней проводится в течении часа с интервалом 15 минут;\n'
                      '* перед монтажом УЭЦН замер уровней производить в течение 1 часа с интервалом в 15 мин для '
                      'определения стабильности статического уровня (если уровень не стабилен, добиться его '
                      'стабилизации регулированием объема долива, при не стабильном уровне в скважине - '
                      ...
                      '* при проведении СПО периодичность замера уровней - 1 раз в 6 часов.',
             None, None, None, None, None, None, None, None, None],
            [None, 4, 'При изменении уровня в скважине от первоначального на 100 м и более в сторону уменьшения '
                      'или возрастания, необходимо скорректировать объем долива и добиться стабилизации уровня'
                      ' жидкости в скважине. Если по данным замера уровень в скважине растет, необходимо выполнить'
                      ' повторное глушение скважины, сделав перерасчет плотности жидкости глушения,в соответствии с '
                      'уточненными геологической службой данными по пластовому давлению. \n'
            ...
            [None, 4,
             ...
             ' спайдера.', None, None, None, None, None, None, None,
