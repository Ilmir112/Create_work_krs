...
class DrillWindow(WindowUnion):
    ...
    def drilling_nkt(self, drill_tuple, drill_type_combo, drilling_bit_diam, downhole_motor,
        ...
        drilling_list = [
            ...
            [None, None,
             f'При работе с вертлюгами обеспечить наличие метки, нанесенной белой краской на муфтовое резьбовое '
             f'соединение вертлюга с рабочей трубой. При вращении компoновки контролировать состоянии метки во '
             f'избежании развинчивания резьбового соединения. При появлении признаков развинчивания работы '
             f'ОСТАНОВИТЬ, дальнейшие работы проводить в зависимости от ситуации только в присутствии '
             f'ответственного ИТР (старший мастер, мастер по сложным работам).',
             None, None, None, None, None, None, None,
    ...
    def drilling_sbt(self, drill_tuple, drill_type_combo, drilling_bit_diam, downhole_motor=None):
        ...
        drilling_list_end = [
            ...
            [None, None,
             ...
             f'объеме {round(self.data_well.current_bottom * 1.4 / 1000, 1)}м3 тех. жидкостью  уд.весом '
