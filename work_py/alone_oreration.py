...
def pvo_cat1(self):
    ...
    pvo_1 = f'Установить ПВО  по  схеме №2 утвержденной главным инженером {well_data.contractor} от 07.03.2024г ' \
...
def pvo_gno(kat_pvo):
    # print(f' ПВО {kat_pvo}')
    pvo_2 = f'Установить ПВО по схеме №2 утвержденной главным инженером {well_data.contractor} от 07.03.2024г (тип плашечный ' \
