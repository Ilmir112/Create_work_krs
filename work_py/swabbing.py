    ...
    def swabbing_opy(self, depth_opy, fluid_new, need_change_zgs_combo, plast_new,
        ...
        paker_list = [
            ...
            [None, None,
             ...
             'мастер КРС', None],
            [None, None,
             f'Произвести  монтаж СВАБа согласно схемы  №8 при свабированиии утвержденной главным инженером от {well_data.dict_contractor[well_data.contractor]["Дата ПВО"]}г. '
