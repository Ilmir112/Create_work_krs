...
events_gnvp_gnkt = [
        ...
        [None, '5. Производить опрессовку плашек ПВО  на максимально'
...
events_gnvp = [
        ...
        [None, '4.Контроль воздушной среды КВС проводить имеющимся в наличии в бригаде капитального, текущего ремонта '
               ...
               ', БКФ или ДОТ и БРИЗ) согласно ПЛА. Результаты замеров заносить в журнал КВС.',
         None, None, None, None, None, None, None, None, None],
        [None, '5. Оборудовать устье скважины согласно по схеме, утвержденной главным инженером ООО "Ойл-сервис от'
               ' 14.10.2021г, согласно схемы обвязки устья скважин  на месторождениях ООО Башнефть-Добыча превенторной'
               ' установкой при капитальном, текущем ремонте, освоении для скважин, соответствующей категории по '
    ...
    itog_1 = [
        [None, 'ИТОГО:', None, None, None, None, None, None, None, None, None, f'=ROUND(SUM(L{CreatePZ.itog_ind_min}:L{CreatePZ.itog_ind_max}),1)'],
                  [None, 'Герметизация ,  разгерметизация  устья  скважины', None, None, None, None, None, None, None,
                   None, None, f'=ROUND(L{CreatePZ.itog_ind_max+1}/11.5*11/60 ,1)'],
                  [None, 'Заправка ДВС', None, None, None, None, None, None, None, None, None, f'=ROUND(L{CreatePZ.itog_ind_max+1}/23*0.13 ,1)'],
                  [None, 'ПЗР в начале и конце смены с заполнением вахтового журнала', None, None, None, None, None,
                   None, None, None, None, f'=ROUND(L{CreatePZ.itog_ind_max+1}/11.5*0.3,1)'],
                  [None, 'Непредвиденные  работы  : ', None, None, None, None, None, None, None, None, None, f'=ROUND(L{CreatePZ.itog_ind_max+1}*{CreatePZ.bottomhole_artificial}/100*0.0004 ,1)'],
