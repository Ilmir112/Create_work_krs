...
def paker_list(self):
    ...
    if pressureZUMPF_answer:
        paker_list = [
            [None, None,
             f'Спустить {paker_select(self)} на НКТ{CreatePZ.nkt_diam}мм до глубины {pakerDepthZumpf}м,'
        ...
        paker_list = [
            [None, None,
             f'Спустить {paker_select(self)} на НКТ{CreatePZ.nkt_diam}мм до глубины {paker_depth}м, '
    ...
    if len(CreatePZ.dict_leakiness) != 0:
        ...
        if int(dict_leakinest_keys[0][0]) < paker_depth:
            ...
            if NEK_question == QMessageBox.StandardButton.Yes:
                ...
                paker_list = [
                    [None, None,
                     f'Спустить {paker_select(self)} на НКТ{CreatePZ.nkt_diam}мм до глубины {pakerNEK}м, воронкой '
                ...
                while len(dict_leakinest_keys) - ind_nek != 0:
                    ...
                    pressureNEK_list = [[None, None,
                                        ...
                                        [None, None,
                                         ...
                                         f'интервале {pakerNEK1}-0м на Р={CreatePZ.max_admissible_pressure}атм'
                                         f' в течение 30 минут  в присутствии представителя заказчика, составить акт.',
                                         None, None, None, None, None, None, None,
                                         'мастер КРС', 0.77],
                                        [None, None,
