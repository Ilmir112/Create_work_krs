...
def work_krs(self, work_plan):
    ...
    if work_plan != 'dop_plan':
        ...
        lift_pump_nv = [
            [None, None,
             f'Опрессовать ГНО на Р={40}атм в течении 30мин в присутствии представителя ЦДНГ. Составить акт. (Вызов представителя осуществлять '
             f'телефонограммой за 12 часов, с подтверждением за 2 часа до начала работ) ПРИ НЕГЕРМЕТИЧНОСТИ НКТ ПОДЪЕМ ВЕСТИ С КАЛИБРОВКОЙ',
             None, None, None, None, None, None, None,
             'Мастер КРС представитель Заказчика ', 0.7],
            [None, None,
            ...
            [None, None,
             ...
             f'инженером от 14.10.2021г при СПО штанг (ПМШ 62х21 либо аналог). Опрессовать ПВО на {CreatePZ.max_expected_pressure}атм.  Поднять на штангах насос '
        ...
        lift_pump_nn = [
            ...
            [None, None,
             ...
             f'инженером от 14.10.2021г при СПО штанг (ПМШ 62х21 либо аналог). Опрессовать ПВО на {CreatePZ.max_expected_pressure}атм. Заловить конус спуском одной '
...
def well_jamming(self, without_damping, lift_key):
    ...
    if without_damping == True:
        ...
        well_jamming_list1 = f'Произвести закачку в затрубное пространство тех жидкости в ' \
