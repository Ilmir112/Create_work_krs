...
def pvo_gno(kat_pvo):
    ...
    pvo_1 = f'Установить ПВО  по  схеме №1 утвержденной главным инженером ООО "Ойл-сервис" от 14.10.2021г  (тип плашечный сдвоенный ПШП-2ФТ-160х21Г Крестовина КР160х21Г, ' \
            ...
            f'- Обеспечить о обогрев превентора, станции управления ПВО оборудовать теплоизоляционными материалом механические задвижки манифольдные линии до блока дросселирования\n' \
